...
namespace TheOtherRoles.Patches {
    ...
    public static class PlayerControlFixedUpdatePatch {
        ...
        static void bomber2SetTarget() {
            ...
            if (Bomber2.bomber2 == null || Bomber2.bomber2 != PlayerControl.LocalPlayer) return;
        ...
        static void setBomber2BombTarget() {
            if (Bomber2.bomber2 == null || Bomber2.hasBomb != PlayerControl.LocalPlayer) return;
    ...
    //        setPlayerOutline(Cultist.currentTarget, Palette.ImpostorRed);
        ...
        public static void updatePlayerInfo() {
            ...
            foreach (PlayerControl p in PlayerControl.AllPlayerControls.ToArray()) {
                ...
                if ((Lawyer.lawyerKnowsRole && PlayerControl.LocalPlayer == Lawyer.lawyer && p == Lawyer.target) || p == PlayerControl.LocalPlayer || PlayerControl.LocalPlayer.Data.IsDead || (PlayerControl.LocalPlayer == Slueth.slueth && Slueth.reported.Any(x => x.PlayerId == p.PlayerId)) || TORMapOptions.impostorSeeRoles && Spy.spy == null && PlayerControl.LocalPlayer.Data.Role.IsImpostor && !PlayerControl.LocalPlayer.Data.IsDead && p == (p.Data.Role.IsImpostor && !p.Data.IsDead) || (PlayerControl.LocalPlayer == Poucher.poucher && Poucher.killed.Any(x => x.PlayerId == p.PlayerId))) {
                    ...
                    if (p == PlayerControl.LocalPlayer || (TORMapOptions.impostorSeeRoles && Spy.spy == null && PlayerControl.LocalPlayer.Data.Role.IsImpostor && !PlayerControl.LocalPlayer.Data.IsDead && p == (p.Data.Role.IsImpostor && !p.Data.IsDead))) {
        ...
        public static void arsonistSetTarget() {
            ...
            {
                untargetables = new();
                foreach (PlayerControl cachedPlayer in PlayerControl.AllPlayerControls.ToArray())
                {

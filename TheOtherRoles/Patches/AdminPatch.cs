...
namespace TheOtherRoles.Patches {
    ...
    public class AdminPatch
    {
        ...
        static void UseAdminTime()
        {
            ...
            if (TORMapOptions.restrictDevices > 0 && TORMapOptions.restrictAdminTime > 0f && PlayerControl.LocalPlayer.isAlive())
            {
        ...
        public static class MapConsoleUsePatch
        {
            ...
            {
                return TORMapOptions.canUseAdmin;
            }
        }
        ...
        class MapCountOverlayUpdatePatch
        {
            ...
            static bool Prefix(MapCountOverlay __instance)
            {
                ...
                if (TORMapOptions.restrictDevices > 0)
                {
                    ...
                    if (TORMapOptions.restrictAdminTime <= 0f && (PlayerControl.LocalPlayer != Hacker.hacker && !PlayerControl.LocalPlayer.Data.IsDead))
                    {
                    ...
                    string timeString = TimeSpan.FromSeconds(TORMapOptions.restrictAdminTime).ToString(@"mm\:ss\.ff");
                                ...
                                if (!(collider2D.tag == "DeadBody"))
                                {
                                    ...
                                    else if (component?.cosmetics?.currentBodySprite?.BodySprite?.material != null)
                                    {
                                        ...
                                        if (Hacker.onlyColorType)
                                        {
                                            ...
                                            color = Helpers.isLighterColor2((byte)id) ? Palette.PlayerColors[7] : Palette.PlayerColors[6];
                                        }
                                ...
                                else
                                {
                                    ...
                                    if (component)
                                    {
                                        ...
                                        if (playerInfo != null)
                                        {
                                            ...
                                            if (Hacker.onlyColorType)
                                                color = Helpers.isLighterColor2(playerInfo.Object.CurrentOutfit.ColorId) ? Palette.PlayerColors[7] : Palette.PlayerColors[6];
                                            roomColors.Add(color);
                                        }
                                    }
                                }

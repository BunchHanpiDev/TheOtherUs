...
/*
            ...
            */
            ...
            sheriffKillButton = new CustomButton(
                () => {
                    ...
                    if (murderAttemptResult == MurderAttemptResult.PerformKill)
                    {
                        ...
                        {
                            targetId = Sheriff.currentTarget.PlayerId;
                            MessageWriter killWriter2 = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.UncheckedMurderPlayer, Hazel.SendOption.Reliable, -1);
            ...
            veterenAlertButton = new CustomButton(
                () => {
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.VeterenAlert, Hazel.SendOption.Reliable, -1);
                    AmongUsClient.Instance.FinishRpcImmediately(writer);
      ...
      //              SoundEffectsManager.play("shifterShift");
            ...
            morphlingButton = new CustomButton(
                ...
                () => { 
                    ...
                    return (Morphling.currentTarget || Morphling.sampledTarget) && !Helpers.isActiveCamoComms() && PlayerControl.LocalPlayer.CanMove && !Helpers.MushroomSabotageActive(); },
                () => { 
            ...
            bodyGuardGuardButton = new CustomButton(
                () => {
                    ...
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.BodyGuardGuardPlayer, Hazel.SendOption.Reliable, -1);
            ...
            privateInvestigatorWatchButton = new CustomButton(
                () => {
                    ...
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.PrivateInvestigatorWatchPlayer, Hazel.SendOption.Reliable, -1);
            ...
            swooperSwoopButton = new CustomButton(
                ...
                () => { /* Can See */ return Jackal.canSwoop && Jackal.jackal != null && Jackal.jackal == PlayerControl.LocalPlayer && !PlayerControl.LocalPlayer.Data.IsDead; },
                () => {  /* On Click */ 
           ...
           // }
            ...
            bomber2BombButton = new CustomButton(
                ...
                if (Helpers.checkAndDoVetKill(Bomber2.currentTarget)) return;
                    ...
                    MessageWriter bombWriter = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.GiveBomb, Hazel.SendOption.Reliable, -1);
                ...
                () => { /* Can See */ return Bomber2.bomber2 != null && Bomber2.bomber2 == PlayerControl.LocalPlayer && !PlayerControl.LocalPlayer.Data.IsDead; },
                () => {  /* On Click */ return (Bomber2.currentTarget && PlayerControl.LocalPlayer.CanMove); },
                () => {  /* On Meeting End */
                    bomber2BombButton.Timer = bomber2BombButton.MaxTimer;
            ...
            bomber2KillButton = new CustomButton(
                () => { /* On Use */ 
                    if (Bomber2.currentBombTarget == Bomber2.bomber2) {
                        ...
                        MessageWriter bombWriter1 = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.GiveBomb, Hazel.SendOption.Reliable, -1);
                ...
                () => { /* Can See */ return Bomber2.bomber2 != null && Bomber2.hasBomb == PlayerControl.LocalPlayer && Bomber2.bombActive && !PlayerControl.LocalPlayer.Data.IsDead; },
                () => {  /* Can Click */ return (Bomber2.currentBombTarget && PlayerControl.LocalPlayer.CanMove); },
                () => {  /* On Meeting End */ },
                Bomber2.getButtonSprite(),
                //          0, -0.06f, 0
                        ...
                        if (collider2D.tag == "DeadBody") {
                            ...
                            if (component && !component.Reported) {
                                ...
                                if (Vector2.Distance(truePosition2, truePosition) <= PlayerControl.LocalPlayer.MaxReportDistance && PlayerControl.LocalPlayer.CanMove && !PhysicsHelpers.AnythingBetween(truePosition, truePosition2, Constants.ShipAndObjectsMask, false)) {
                                    ...
                                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.AmnisiacTakeRole, Hazel.SendOption.Reliable, -1);
                                    writer.Write(playerInfo.PlayerId);
                                    AmongUsClient.Instance.FinishRpcImmediately(writer);
           ...
           // Jackal Sidekick Button
            cultistTurnButton = new CustomButton(
                () => {
                    ...
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.CultistCreateImposter, Hazel.SendOption.Reliable, -1);
